...
wilcox.test(pvlitM~FNFAET12, data = newdata)$p.value #p-value <2e-16
wilcox.test(pvlitM~FNFAET12JR, data = newdata)$p.value # 6.0868e-11
wilcox.test(pvlitM~FNFAET12NJR, data = newdata)$p.value #0.00042702
...
step(full.num,direction="forward") 
#GENDER_R + AGE_R + ED_Level + Full_part + Years_wk + pub_priv + work_flexM + work_lrnM + act_lrn + NFE12 + FNFAET12JR + FNFAET12NJR + NFEHRS, different

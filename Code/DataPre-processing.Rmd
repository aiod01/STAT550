...
unique(newdata$Years_wk)
newdata$Years_wk <-cut(newdata$Years_wk, c(0,10,20,30,40,100), right=FALSE)
boxplot(pvnumM~Years_wk,data=newdata, main="pvnumM vs work year", 
      xlab="work year", ylab="numeracy score")
summary(aov(pvnumM~Years_wk,data=newdata))

# pvnum vs work_flexM
newdata$flex_cat <-cut(newdata$work_flexM, c(1,2,3,4,6), right=FALSE)
boxplot(pvnumM~flex_cat,data=newdata, main="pvnumM vs work flexibility", 
      xlab="work flexibility", ylab="numeracy score")
summary(aov(pvnumM~flex_cat,data=newdata))

# pvnum vs active learning
boxplot(pvnumM~act_lrn,data=newdata, main="pvnumM vs active learning", 
      xlab="active learning", ylab="numeracy score")
summary(aov(pvnumM~act_lrn,data=newdata))

# pvnum vs private/public
boxplot(pvnumM~Full_part,data=newdata, main="pvnumM vs private/public sector", 
      xlab="private/public sector", ylab="numeracy score")
summary(aov(pvnumM~Full_part,data=newdata))

# pvnum vs None formal education
boxplot(pvnumM~NFE12,data=newdata, main="pvnumM vs None formal education", 
      xlab="None formal education", ylab="numeracy score")
summary(aov(pvnumM~NFE12,data=newdata))

# pvnum vs adult eduction
boxplot(pvnumM~FNFAET12,data=newdata, main="pvnumM vs adult eduction", 
      xlab="adult eduction", ylab="literacy score")
summary(aov(pvnumM~FNFAET12,data=newdata))

# pvnum vs adult eduction
unique(newdata$NFEHRS)
summary(lm(pvnumM~NFEHRS,data=newdata))
boxplot(pvnumM~NFEHRS,data=newdata, main="pvnumM vs eductaion", 
      xlab="adult eduction", ylab="literacy score")
summary(aov(pvnumM~NFEHRS,data=newdata))
```

...
Subset_Data = MAIN_data[,c("AGE_R","Years_wk","work_flexM","work_lrnM","act_lrn","NFEHRS","lit_use_new","pvnumM")]
...
```
```{r}
#covariance plot for numerical variables.
#I don't know why there is ? marks on the plot.
...
```
```{r}
boxplot(lit_use_new~GENDER_R,data=MAIN_data, main="gender vs lit_use_new", xlab="gender", ylab="literacy score")

...
Var_Removal = c("AGEG5LFS", "AGEG10LFS", "Mgr", "Mgr_c", "lit_use_new", "pvnumM", "FNFE12JR", "FNFAET12", "EMPloyed",
...
newdata.numeric <- na.omit(newdata.numeric)
...
catcorrm <- function(categorical, MAIN_data) sapply(categorical, function(y) sapply(categorical, function(x) 
...
ggplot(MAIN_data, aes(x=num_use_new)) + 
  geom_bar(color="red", fill="white")

ggplot(MAIN_data, aes(x=lit_use_new)) + 
...
(ggplot(MAIN_data, aes(y=lit_use_new, x=Full_part,color=Full_part)) + geom_boxplot()+stat_summary(fun.y=mean, geom="point", shape=23, size=4,color='blue')+ geom_jitter(shape=1, position=position_jitter(0.3)))
#boxplot(lit_use_new~Full_part,data=MAIN_data, main="lit_use_new vs full/part time", xlab="full/part time", ylab="literacy score")

# lit_use_new vs education
(ggplot(MAIN_data, aes(y=lit_use_new, x=ED_Level, color=ED_Level)) + geom_boxplot()+stat_summary(fun.y=mean, geom="point", shape=23, size=4))
#boxplot(lit_use_new~ED_Level,data=MAIN_data, main="lit_use_new vs education", xlab="education", ylab="literacy score")

# lit_use_new vs private/public
(ggplot(MAIN_data, aes(y=lit_use_new, x=pub_priv, color=pub_priv)) + geom_boxplot()+stat_summary(fun.y=mean, geom="point", shape=23, size=4))
#boxplot(lit_use_new~pub_priv,data=MAIN_data, main="lit_use_new vs private/public sector", xlab="private/public sector", ylab="literacy score")

# lit_use_new vs None formal education
(ggplot(MAIN_data, aes(y=lit_use_new, x=NFE12,color=NFE12)) + geom_boxplot()+stat_summary(fun.y=mean, geom="point", shape=23, size=4))
#boxplot(lit_use_new~NFE12,data=MAIN_data, main="lit_use_new vs None formal education", xlab="None formal education", ylab="literacy score")

# lit_use_new vs adult eduction
(ggplot(MAIN_data, aes(y=lit_use_new, x=FNFAET12, group=FNFAET12,color=FNFAET12)) + geom_boxplot()+stat_summary(fun.y=mean, geom="point", shape=23, size=4))
#boxplot(lit_use_new~FNFAET12,data=MAIN_data, main="lit_use_new vs adult eduction", xlab="adult eduction", ylab="literacy score")
```
